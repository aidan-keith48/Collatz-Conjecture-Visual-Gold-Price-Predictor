...
{
    public partial class GoldPriceModel
    {
        public const string RetrainFilePath =  @"C:\Users\aidan\Downloads\gold_price_3_years.csv";
        ...
        public static IEstimator<ITransformer> BuildPipeline(MLContext mlContext)
        {
            ...
            var pipeline = mlContext.Forecasting.ForecastBySsa(windowSize:45,seriesLength:427,trainSize:1095,horizon:10,outputColumnName:@"Gold_Price_USD_per_Ounce",inputColumnName:@"Gold_Price_USD_per_Ounce",confidenceLowerBoundColumn:@"Gold_Price_USD_per_Ounce_LB",confidenceUpperBoundColumn:@"Gold_Price_USD_per_Ounce_UB");
